          ...
          <div className="col-12">
            <div className="section__header">
              ...
              <h2
                ...
                data-aos-delay="100"
              >
                Get Started With the free trail
              </h2>
              <div
                className="paragraph "
                data-aos="fade-up"
              ...
              >
                <p>
                  Welcome to our professional clipping path service, where we
                  provide high-quality and affordable image editing solutions to
