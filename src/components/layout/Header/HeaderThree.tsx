...
const HeaderThree = ({ openNav, handleNav, setOpenNav }: HeaderProps) => {
  ...
  return (
    <>
      <div className="home-two-topbar d-none d-lg-block">
        <div className="container">
          <div className="row gaper align-items-center">
            <div className="col-12 col-lg-6">
              <div className="home-two-top__left">
                <p className="fw-6 text-center text-lg-start">
                  We Save Your Cost Up To 50%
                </p>
              </div>
            </div>
            <div className="col-12 col-lg-6">
              <div className="home-two-top__right">
